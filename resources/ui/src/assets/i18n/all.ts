const customTranslations: Record<string, Record<string, string>> = {
  english: {
    ...
    pref_household: "Household",
    pref_people_label: "Number of people",
    pref_kitchen_equipment: "Kitchen Equipment",
    pref_equipment_label: "What equipment do you have?",
    pref_budget_time: "Budget & Time",
    pref_max_time: "Maximum cooking time",
    pref_budget_person: "Budget per person",
    pref_auto_save: "Your preferences are automatically saved",
    people_1: "1 person",
    people_2: "2 people",
    people_4: "4 people",
    people_6: "6 people",
    people_8: "8+ people",
    equipment_stovetop: "Stovetop",
    equipment_oven: "Oven",
    equipment_microwave: "Microwave",
    equipment_airfryer: "Air Fryer",
    equipment_instantpot: "Instant Pot",
    equipment_ricecooker: "Rice Cooker",
  ...
  french: {
    ...
    pref_household: "Ménage",
    pref_people_label: "Nombre de personnes",
    pref_kitchen_equipment: "Équipement de Cuisine",
    pref_equipment_label: "Quel équipement avez-vous?",
    pref_budget_time: "Budget et Temps",
    pref_max_time: "Temps de cuisson maximum",
    pref_budget_person: "Budget par personne",
    pref_auto_save: "Vos préférences sont automatiquement sauvegardées",
    people_1: "1 personne",
    people_2: "2 personnes",
    people_4: "4 personnes",
    people_6: "6 personnes",
    people_8: "8+ personnes",
    equipment_stovetop: "Cuisinière",
    equipment_oven: "Four",
    equipment_microwave: "Micro-ondes",
    equipment_airfryer: "Friteuse à air",
    equipment_instantpot: "Autocuiseur",
    equipment_ricecooker: "Cuiseur à riz",
    equipment_blender: "Mixeur",
  ...
  italian: {
    ...
    pref_household: "Famiglia",
    pref_people_label: "Numero di persone",
    pref_kitchen_equipment: "Attrezzatura da Cucina",
    pref_equipment_label: "Quale attrezzatura hai?",
    pref_budget_time: "Budget e Tempo",
    pref_max_time: "Tempo di cottura massimo",
    pref_budget_person: "Budget per persona",
    pref_auto_save: "Le tue preferenze vengono salvate automaticamente",
    people_1: "1 persona",
    people_2: "2 persone",
    people_4: "4 persone",
    people_6: "6 persone",
    people_8: "8+ persone",
    equipment_stovetop: "Piano cottura",
    equipment_oven: "Forno",
    equipment_microwave: "Microonde",
    equipment_airfryer: "Friggitrice ad aria",
    equipment_instantpot: "Pentola a pressione",
    equipment_ricecooker: "Cuociriso",
    equipment_blender: "Frullatore",
  ...
  spanish: {
    ...
    pref_household: "Hogar",
    pref_people_label: "Número de personas",
    pref_kitchen_equipment: "Equipo de Cocina",
    pref_equipment_label: "¿Qué equipo tienes?",
    pref_budget_time: "Presupuesto y Tiempo",
    pref_max_time: "Tiempo máximo de cocción",
    pref_budget_person: "Presupuesto por persona",
    pref_auto_save: "Tus preferencias se guardan automáticamente",
    people_1: "1 persona",
    people_2: "2 personas",
    people_4: "4 personas",
    people_6: "6 personas",
    people_8: "8+ personas",
    equipment_stovetop: "Estufa",
    equipment_oven: "Horno",
    equipment_microwave: "Microondas",
    equipment_airfryer: "Freidora de aire",
    equipment_instantpot: "Olla instantánea",
    equipment_ricecooker: "Arrocera",
    equipment_blender: "Licuadora",
    equipment_foodprocessor: "Procesador de alimentos",
  },
arabic:{
    ...
    "pref_household": "الأسرة",
    "pref_people_label": "عدد الأشخاص",
    "pref_kitchen_equipment": "معدات المطبخ",
    "pref_equipment_label": "ما هي المعدات المتوفرة لديك؟",
    "pref_budget_time": "الميزانية والوقت",
    "pref_max_time": "الحد الأقصى لوقت الطهي",
    "pref_budget_person": "الميزانية لكل شخص",
    "pref_auto_save": "يتم حفظ تفضيلاتك تلقائيًا",
    "people_1": "شخص واحد",
    "people_2": "شخصان",
    "people_4": "4 أشخاص",
    "people_6": "6 أشخاص",
    "people_8": "8+ أشخاص",
    "equipment_stovetop": "موقد",
    "equipment_oven": "فرن",
    "equipment_microwave": "ميكروويف",
    "equipment_airfryer": "قلاية هوائية",
    "equipment_instantpot": "قدر فوري",
    "equipment_ricecooker": "طباخ أرز",
    "equipment_blender": "خلاط",
    "equipment_foodprocessor": "محضر طعام"
}
};
